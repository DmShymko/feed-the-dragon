...
#Set fonts
font = pygame.font.Font("resources/fonts/AttackGraffiti.ttf", 32)
...
coin_sound = pygame.mixer.Sound("resources/sounds/coin_sound.wav")
miss_sound = pygame.mixer.Sound("resources/sounds/miss_sound.wav")
miss_sound.set_volume(.1)
pygame.mixer.music.load("resources/sounds/ftd_background_music.wav")

#Set the images
player_image = pygame.image.load("resources/images/dragon_right.png")
player_rect = player_image.get_rect()
player_rect.left = 32
player_rect.centery = WINDOW_HEIGHT//2

coin_image = pygame.image.load("resources/images/coin.png")
